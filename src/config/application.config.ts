...
const INITIAL_YOUTUBE_ALLOWED_DURATION_MINUTES = 60;
const INITIAL_YOUTUBE_COOLDOWN_DURATION_MINUTES = 60;
...
const MIN_YOUTUBE_ALLOWED_DURATION_MINUTES = 1;
const MAX_YOUTUBE_ALLOWED_DURATION_MINUTES = 1_440;
const MIN_YOUTUBE_COOLDOWN_DURATION_MINUTES = 1;
const MAX_YOUTUBE_COOLDOWN_DURATION_MINUTES = 1_440;
...
export const applicationConfig = {
  policy: {
    initial: {
      shorts: {
        allowedDuration: DurationMs.fromMinutes(INITIAL_ALLOWED_DURATION_MINUTES),
        cooldownDuration: DurationMs.fromMinutes(INITIAL_COOLDOWN_DURATION_MINUTES),
      },
      youtube: {
        allowedDuration: DurationMs.fromMinutes(INITIAL_YOUTUBE_ALLOWED_DURATION_MINUTES),
        cooldownDuration: DurationMs.fromMinutes(INITIAL_YOUTUBE_COOLDOWN_DURATION_MINUTES),
      },
    },
  },
  constraints: {
    ...
    youtube: {
      allowedDuration: {
        min: DurationMs.fromMinutes(MIN_YOUTUBE_ALLOWED_DURATION_MINUTES),
        max: DurationMs.fromMinutes(MAX_YOUTUBE_ALLOWED_DURATION_MINUTES),
      },
      cooldownDuration: {
        min: DurationMs.fromMinutes(MIN_YOUTUBE_COOLDOWN_DURATION_MINUTES),
        max: DurationMs.fromMinutes(MAX_YOUTUBE_COOLDOWN_DURATION_MINUTES),
      },
    },
  },
  urls: {
